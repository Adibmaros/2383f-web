...
export default function EditPostPage({ params }: any) {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold mb-6 text-gray-900 dark:text-gray-100">Edit Post</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          {(imageFile || formData.mainImage) && (
            <div className="mt-3">
              <img
                src={imageFile ? URL.createObjectURL(imageFile) : urlFor(formData.mainImage).width(300).url()}
                alt="Preview"
                ...
                className={`px-4 py-2 rounded-lg border transition-colors
                          ${
                            formData.categoryIds.includes(category._id)
                              ...
                              : "bg-white dark:bg-gray-800/50 text-gray-700 dark:text-gray-200 border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-400"
                          }`}
              >
                {category.title}
              </button>

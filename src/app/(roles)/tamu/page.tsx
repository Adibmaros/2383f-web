            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <div className="flex items-center space-x-8">
                <a href="#" className="group text-gray-400 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Facebook">
                  <Facebook className="sm:h-6 sm:w-6 h-4 w-4 transition-all duration-300 ease-in-out group-hover:scale-110" />
                </a>

                <a href="#" className="group text-gray-400 hover:text-sky-500 dark:hover:text-sky-400" aria-label="Twitter">
                  <Twitter className="sm:h-6 sm:w-6 h-4 w-4 transition-all duration-300 ease-in-out group-hover:scale-110" />
                </a>
                ...
                <a href="https://www.instagram.com/si23f_radenfatah" className="group text-gray-400 hover:text-pink-500 dark:hover:text-pink-400" aria-label="Instagram">
                  <Instagram className="sm:h-6 sm:w-6 h-4 w-4 transition-all duration-300 ease-in-out group-hover:scale-110" />
                </a>

                <a href="#" className="group text-gray-400 hover:text-blue-600 dark:hover:text-blue-400" aria-label="LinkedIn">
                  <Linkedin className="sm:h-6 sm:w-6 h-4 w-4 transition-all duration-300 ease-in-out group-hover:scale-110" />
                </a>
              </div>

              {/* Copyright */}
              <p className="text-gray-500 dark:text-gray-400 sm:font-medium font-sans text-sm sm:text-lg">© 2025 SI F'23. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>

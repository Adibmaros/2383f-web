...
import { Layout, FileText, Users, Tag, Menu, X, ChartColumnIncreasing } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin-kelas/hasil-karya", label: "Hasil Karya", icon: ChartColumnIncreasing },
];
